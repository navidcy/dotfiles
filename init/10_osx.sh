...
# Derived from mathiasbynens's macos setup script
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.750000 0.750000 0.750000"
...
# Set a blazingly fast keyboard repeat rate (was 1 and 10)
...
# Use duckduckgo as search provider
